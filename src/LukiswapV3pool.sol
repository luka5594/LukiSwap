...
contract LukiswapV3pool{
    ...
    constructor() {
        (factory, token0, token1, tickSpacing) = ILukiswapV3PoolDeployer(
            msg.sender
        ).parameters();
    }
    ...
    function mint(
        ...
        IUniswapMintCallback(msg.sender).uniswapV3MintCallback(
            amount0,
            amount1,
            data
        );
    ...
    function flash(
        ...
        ILukiswapV3FlashCallback(msg.sender).uniswapV3FlashCallback(data);
