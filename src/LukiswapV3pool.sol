...
import "./interfaces/IUniswapMintCallback.sol";
import "./interfaces/IUniswapV3SwapCallback.sol";
import "./interfaces/ILukiswapV3FlashCallback.sol";
import "./interfaces/ILukiswapV3PoolDeployer.sol";
import "./interfaces/ILukiswapV3Pool.sol";

import "prb-math/UD60x18.sol";

//import "./LukiswapV3Manager.sol";
...
contract LukiswapV3pool is ILukiswapV3Pool{
    ...
    constructor() {
        (factory, token0, token1, tickSpacing, fee) = ILukiswapV3PoolDeployer(
            msg.sender
        ).parameters();
    }
    ...
    function mint(
        ...
        IUniswapMintCallback(msg.sender).uniswapMintCallback(
            amount0,
            amount1,
            data
        );
    ...
    function flash(
        ...
        ILukiswapV3FlashCallback(msg.sender).uniswapV3FlashCallback(
            fee0,
            fee1,
            data
        );
